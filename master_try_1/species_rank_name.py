...
def get_user_arguments(): ######
    ...
    Vars -
        scientific_name:
            Search term. Should be a species scientific name following the example: "Canis lupus".
        taxonomy_rank:
            Taxonomy Rank relation. If you dont know what to do here enter an item of this list:
